...
main(){
  RPI_checkMachine("BaroP_RPI_UXC", "rpiControlPressureUXC");  
  RPI_checkMachine("BaroP_RPI_SX5", "rpiControlPressureSX5");  
  RPI_checkMachine("WaterP_RPI_X0", "rpiControlCoolingUXC_X0");  
  RPI_checkMachine("BaroP_RPI_UGX", "rpiControlPressureUGX");    
  RPI_checkMachine("BaroP_RPI_MQN", "rpiControlPressureMilliQan");    
  RPI_checkMachine("BaroP_RPI_UXC2", "rpiControlPressureUXC_2");    
} 
...
/*void main(){
  ...
  string dpUpTime=getSystemName()+"rpiControlPressureUXC.upTime";
  string dpIsUpTimeOK=getSystemName()+"rpiControlPressureUXC.isUpTimeOK";
  string dpEmailFlag=getSystemName()+"rpiControlPressureUXC.emailFlag";
